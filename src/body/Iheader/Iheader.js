...
class Iheader extends Component {
  ...
  permissionControl = () => {
    const displayArr = ['none', 'none', "none", "none", "none", "none", "none", "none"];
    const rolesArr = window.localStorage.roles.split(',');
    // console.log('rolesArr.indexOf(1) != -1')
    // console.log(rolesArr.indexOf('1'))
    // console.log(rolesArr.indexOf('71'))
    ...
    if (rolesArr.indexOf('61') != -1) {//化验室荧光分析员
      displayArr[0] = '';
      displayArr[2] = '';
      displayArr[3] = '';
      displayArr[4] = '';
    ...
    if (rolesArr.indexOf('62') != -1) {//化验室荧光控制员
      displayArr[0] = '';
      displayArr[2] = '';
      displayArr[3] = '';
      displayArr[4] = '';
    ...
    if (rolesArr.indexOf('71') != -1) {//化验室分析员
    ...
    if (rolesArr.indexOf('72') != -1) {//化验室物检员
      displayArr[0] = '';
      displayArr[2] = '';
      displayArr[3] = '';
      displayArr[4] = '';
