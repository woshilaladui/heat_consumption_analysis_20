...
import {
  HuaYanShiFormat,
  HuaYanShiFormat_searchTable,
  updateOperator,
  ZhongKongShiFormat, ZhongKongShiFormat_searchTable
} from "../../../../Helper/Format";
    ...
    return (dispatch) => {
        requestGetHuaYanShiDataByTableNameAndDate(
            ...
            if(response['code'] === 0){
                ...
                let result = HuaYanShiFormat_searchTable(
                    data,
                    newData,
                    tableName,
                );
            ...
            .then(
                (response)=>{
                    ...
                    if(response['code'] === 0){
                        ...
                        let result = ZhongKongShiFormat_searchTable(
                            data,
                            newData,
                            tableName,
                        );
