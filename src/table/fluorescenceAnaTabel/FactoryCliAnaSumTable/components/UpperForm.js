...
export default class UpperForm extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            average: Array(15 * 3).fill(null),//平均
            ratio: Array(15 * 3).fill(null),//比值
            passRate: Array(15 * 3).fill(null),//合格率
            order: [8, 9, 11],//当前表格需要计算合格率的列数顺序
        }
    }
        ...
        data.push(
            {
                ...
                N: this.state.average[9 + page],
                P: this.state.average[10 + page],
                C3S: this.state.average[11 + page],
                C2S: this.state.average[12 + page],
                C3A: this.state.average[13 + page],
                C4AF: this.state.average[14 + page],
                // Remarks_list:'--',
