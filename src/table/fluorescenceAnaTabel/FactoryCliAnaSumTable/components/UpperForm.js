        ...
        data.push(
            {
                ...
                N:      Data[8 + timeChose * 10]['data'][HuaYSOrder_RMC.KH_],
                P:       Data[8 + timeChose * 10]['data'][HuaYSOrder_RMC.N],
                C3S:     Data[8 + timeChose * 10]['data'][HuaYSOrder_RMC.P],
                C2S:     Data[8 + timeChose * 10]['data'][HuaYSOrder_RMC.C3S],
                C3A:     Data[8 + timeChose * 10]['data'][HuaYSOrder_RMC.C2S],
                C4AF:    Data[8 + timeChose * 10]['data'][HuaYSOrder_RMC.C3A],
                // Remarks_list:'--',
...
const mapStateToProps = (state) => {
    return {
        ...
        order: state.getIn(['FactoryCliAnaSumTable', 'order']),
        width: state.getIn(['FactoryCliAnaSumTable', 'width']),
        tableWidth: state.getIn(['FactoryCliAnaSumTable', 'tableWidth']),
