...
export default class UpperForm extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            average: Array(8 * 3).fill(null),//平均
            ratio: Array(8 * 3).fill(null),//比值
            passRate: Array(8 * 3).fill(null),//合格率
            order: [0, 1, 3],//当前表格需要计算合格率的列数顺序
        }
    }
    ...
    render() {
        ...
        data.push(
            ...
            },
            {
                ...
                IL: this.state.passRate[HuaYSOrder_JC.IL+page],
                SiO2: '',
                Al2O3: this.state.passRate[HuaYSOrder_JC.Al2O3+page],
                Fe2O3: '',
                CaO: '',
                MgO: '',
                HJ: '',
                K2O: '',
                Na2O: '',
                R2O: this.state.passRate[10+page],
                // Remarks_list:'--',
            }
        );
