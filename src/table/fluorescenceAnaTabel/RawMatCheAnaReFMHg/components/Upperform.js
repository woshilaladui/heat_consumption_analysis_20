...
const mapStateToProps = (state) => {
    return {
        ...
        date: state.getIn(['RawMatCheAnaReFMHG', 'date']),
        order: state.getIn(['RawMatCheAnaReFMHG', 'order']),//tableWidth
        width: state.getIn(['RawMatCheAnaReFMHG', 'width']),
        tableWidth: state.getIn(['RawMatCheAnaReFMHG', 'tableWidth']),
        allTime: state.getIn(['RawMatCheAnaReFMHG', 'allTime']),
        timeChose: state.getIn(['RawMatCheAnaReFMHG', 'timeChose']),
        data: state.getIn(['RawMatCheAnaReFMHG', 'data']),
        requestFlag: state.getIn(['RawMatCheAnaReFMHG', 'requestFlag']),
        startValue: state.getIn(['RawMatCheAnaReFMHG', 'startValue']),
        endValue: state.getIn(['RawMatCheAnaReFMHG', 'endValue']),
