            ...
            dataSource.push(
                {
                    ...
                    //         parser={limitDecimals2}//限制输入数值位数
                    //
                    //         onChange={event => this.onInputNumberChange2(event, index, 9)}
                    //     /></span>,
                    KH:
...
const mapStateToProps = (state) => {
    return {
        ...
        order: state.getIn(['RYRawMatCheAnaRe', 'order']),
        width: state.getIn(['RYRawMatCheAnaRe', 'width']),
        tableWidth: state.getIn(['RYRawMatCheAnaRe', 'tableWidth']),
        allTime: state.getIn(['RYRawMatCheAnaRe', 'allTime']),
        ...
        startValue: state.getIn(['RYRawMatCheAnaRe', 'startValue']),
        endValue: state.getIn(['RYRawMatCheAnaRe', 'endValue']),
