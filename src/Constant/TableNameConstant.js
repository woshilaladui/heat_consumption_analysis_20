...
export const TableName ={
    ...
    /**
     * @tableName 福石水泥3000t/d中控室烧成系统运行记录
     * @directory /table/centerControlRoom/burnSysOpRe
     */
    ZHONG_KONG_SHI_SCXT_YXJL:"NS_BSO",


    /**
     * @tableName 福石水泥3000t/d中控室煤磨系统运行记录
     * @directory /table/centerControlRoom/coalSysOpRe
     */
    ZHONG_KONG_SHI_MFXT_YXJL:"NS_CSO",


    /**
     * @tableName 福石水泥3000t/d生产线中控室生料磨系统运行记录
     * @directory /table/centerControlRoom/rawSysOpRe
     */
    ZHONG_KONG_SHI_SLMMM_YXJL: "NS_RSO",

    /**
     * @tableName 临城中联福石水泥有限公司脱硝系统行动记录
     * @directory /table/centerControlRoom/TxSysAcRe
     */
    ZHONG_KONG_SHI_TXXT_YXJL:"NS_TXA",

    /**
     * @tableName 出磨生料荧光分析及配比记录
     * @directory /table/centerControlRoom/RawFAnaRaRe
     */
    ZHONG_KONG_SHI_CMPB_YXJL:"NS_CMS",

    /**
     * @tableName 入窑生料荧光分析及检测记录
     * @directory /table/centerControlRoom/ruYSLYGFXJL
     */
    ZHONG_KONG_SHI_RYSL_JCJL:"NS_RYS",
    ...
    /**
     * @tableName 在线自动检测运行记录(排放物)
     * @directory /table/centerControlRoom/onlineAutoDetOpRe
     */
    ZHONG_KONG_SHI_ZD_JCJL:"NS_OAD",

    /**
     * @tableName 中控日报
     * @directory /table/centerControlRoom/centralControlDaRe
     */
    ZHONG_KONG_SHI_CDR:"NS_CDR",
